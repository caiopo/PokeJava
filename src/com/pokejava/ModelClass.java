...
public abstract class ModelClass {
	...
	public final static String BASE_URL = "http://pokeapi.co/api/v1/";
	...
	protected String get(String urlAddress) {
		String data = "";
		try {
			data = Request.Get(BASE_URL + urlAddress).execute().returnContent().asString();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	/**
	 * @return Date Modified: A date object representing the last time said API
	 *         was updated
	 */
