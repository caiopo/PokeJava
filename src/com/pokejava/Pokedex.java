...
public class Pokedex extends ModelClass {
	...
	/**
	 * I need a method that return all the pokemons names If I use the
	 * getPokemons() method it will do one request per Pokemon so it will be
	 * slow to get all pokemons
	 * 
	...
	public List<String> getPokemonNamesList() {

		Collection<String> collectionNames = getPokemonsNames();

		String[] arrayNames = (String[]) collectionNames.toArray(new String[collectionNames.size()]);
